...
?>
    ...
    <tr>
        <td><button><a href="/add_user">ADD USER</a></button></td>
        <td><button><a href="/payroll_list">PayRoll</a></button></td>
        <td><button><a href="/attendance_list"> ATTENDANCE LIST</a></button></td>
