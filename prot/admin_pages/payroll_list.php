...
<body onclick="getSalary();">
  <button><a href="../admin_pages/admin_profile.php"> BACK</a></button>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="../actions/edit_payroll.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="jobOrder.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fas fa-file"></i></a>
              <a href="memo.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fas fa-bars"></i></a>
            </td>
          </tr>
        <?php
        }
