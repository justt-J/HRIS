...
if (isset($_GET['interview_id'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $insertQuery = "INSERT INTO selected (selected_firstname, selected_lastname, selected_email, selected_contact) VALUES ('$interview_firstname', '$interview_lastname', '$interview_email', '$interview_contact')";
