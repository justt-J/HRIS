...
if (isset($_GET['applicant_id'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $insertQuery = "INSERT INTO denied (denied_firstname, denied_lastname, denied_email, denied_contact) VALUES ('$applicant_firstname', '$applicant_lastname', '$applicant_email', '$applicant_contact')";
