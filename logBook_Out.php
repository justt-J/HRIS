...
<body>
  ...
  <div class="wrapper">
    <h2>ATTENDANCE</h2>
    <form action="actions/actionLog_Out.php" method="POST">
    ...
    <input type="hidden" value="<?php echo $fetch['Firstname'];?>" name="fname" id="fname" required=""/><br><br> 
        ...
        <p><label for="dailyReport">Enter Your DTR::</label></p>
        <textarea id="dailyReport" name="dailyReport" rows="4" cols="50" required=""></textarea>
